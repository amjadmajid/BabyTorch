...
التعلّم العميق: دقته كافية غالبًا، ويستهلك ذاكرة أقل من `float64`، ويجعل الحساب أسرع.
الفكرة هنا تعليمية أيضًا: نريد أن يبقى التركيز على التنسورات والتدرجات، لا على تفاصيل
أنواع البيانات.
