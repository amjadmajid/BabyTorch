...
5. [x] Implement a few reinforcement learning algorithms (REINFORCE, Actor-Critic, DQN, PPO on GridWorld + Snake — see `tutorials/rl/` and book Part III, chapters 9–10)
